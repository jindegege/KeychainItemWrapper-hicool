...
#  Be sure to run `pod spec lint KeychainItemWrapper-hicool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "KeychainItemWrapper-hicool."
  ...
  s.source       = { :git => "https://github.com/jindegege/KeychainItemWrapper-hicool.git", :tag => s.version }
